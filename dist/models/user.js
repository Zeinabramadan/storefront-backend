...
var Users = /** @class */ (function () {
    ...
    Users.prototype.create = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, hash, result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Could not add new user ".concat(user.firstName, ". Error: ").concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    Users.prototype.sign_in = function (firstName, password) {
        return __awaiter(this, void 0, void 0, function () {
