...
describe('Order Model', function () {
    ...
    it('create method should create new order', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.create(testOrder)];
                case 1:
                    result = _a.sent();
    ...
    it('show method should return an order', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.show(testOrder.id)];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual(testOrder);
                    return [2 /*return*/];
