...
var orders = new order_1.OrdersStore();
// Getting orders list
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var ordersList, error_1;
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orders.create(req.body)];
            case 1:
                order = _a.sent();
                res.status(200).json(order);
                return [3 /*break*/, 3];
...
var addProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderID, quantity, productID, order, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, orders.addProduct(quantity, orderID, productID)];
            case 2:
                order = _a.sent();
                res.status(200).json(order);
                return [3 /*break*/, 4];
