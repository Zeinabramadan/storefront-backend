    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, dashboard.productsByCategory(category)];
            case 1:
                products = _a.sent();
                res.json(products);
                return [3 /*break*/, 3];
...
var userOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, orders, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                user_id = req.params.id;
                return [4 /*yield*/, dashboard.userOrders(user_id)];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [3 /*break*/, 3];
...
var dashboard_routes = function (app) {
    ...
    app.get('/users/:id/orders', auth_1.default, userOrders);
    app.get('/products_in_orders', auth_1.default, productsInOrders);
};
