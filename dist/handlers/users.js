...
var UsersInstance = new user_1.Users();
// Getting users list
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var usersList, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, UsersInstance.index()];
            case 1:
                usersList = _a.sent();
                res.json(usersList);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, UsersInstance.show(id)];
            case 1:
                user = _a.sent();
                if (!user) {
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, UsersInstance.create(req.body)];
            case 1:
                user = _a.sent();
