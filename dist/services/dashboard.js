...
var DashboardQueries = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT * FROM products WHERE category in ($1)';
                        return [4 /*yield*/, conn.query(sql, [category])];
                    case 2:
                        result = _a.sent();
                        if (!result.rows.length) {
                            return [2 /*return*/, 'No category with that name!'];
                        }
                        conn.release();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT * FROM products INNER JOIN orders_products ON products.id = orders_products.product_id';
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Could not get products and orders: ".concat(error_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    DashboardQueries.prototype.userOrders = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT firstName, lastName, user_id, status FROM users INNER JOIN orders ON users.id = orders.user_id WHERE users.id = ($1)';
